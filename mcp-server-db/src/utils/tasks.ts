...
export async function createProject(project: {
  ...
  try {
    ...
    console.error("Error creating task:",  err?.response?.data || err?.response?.data || err.message || err);
    throw err;
  }
}
...
export async function createTask(task: {
  ...
  try {
    ...
    console.error("Error creating task:",  err?.response?.data?.detail || err?.response?.data || err.message || err);
    console.error("Error creating task response.data.detail:",  err?.response?.data?.detail);
    throw err;
  }
}
