...
- If the question is about how many tasks does certain project have:
  ...
  - Answer: "<Project id> has X tasks. to do: X, in progress: X, pending approval: X, block: X, complete: X, overdue: X"
...
- If there is error in creation, summarize the error in details.string
  - Answer: "Fail to create because of error X."
Output:
